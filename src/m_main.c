...
#define MENU_STRINGS \
    ...
    _F(MTXT_DITHER_FILTER, "Dedither Filter") \
...
const menuitem_t Menu_Video[] =
{
	...
	{ MTXT_COLOR_DITHER,     42, 100},
    { MTXT_DITHER_FILTER,    42, 110},
    ...
    else
    {
        ...
        else
        {
            ...
            case MTXT_DITHER_FILTER:
                ...
                {
                    S_StartSound(NULL, sfx_switch2);
                    VideoSettings.DeditherFilter ^= true;
                    I_RefreshVideo();
                    ConfigChanged = true;
                    return ga_nothing;
                }
...
void M_VideoDrawer(void)
{
    ...
    for(i = 0; i < itemlines; i++)
    {
        ...
        {
            if (VideoSettings.DeditherFilter)
                text = "On";
            else
                text = "Off";
        }
