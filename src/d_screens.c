...
void D_DrawRETitle(int y)
{
    ST_DrawString(-1,  y, "Doom 64 RE", text_alpha | 0xc080c000);
    ST_Message(-1,  y+16, "version " D64RE_VERSION, text_alpha | 0x8080ff00);
}
...
void D_DrawRE(void)
{
    ...
    D_DrawSplashFire();
    D_DrawRETitle(SPLASH_TITLE_POS);
...
void D_SplashScreen(void) // 8002B988
{
    ...
    text_alpha = 0xff;
    last_ticon = 0;
    MiniLoop(NULL, NULL, D_RETicker, D_DrawRE);
